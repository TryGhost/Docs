...
Now that you’ve successfully updated from Ghost 0.x versions to 1.0, you can proceed to update to the latest version to access all [new features](https://ghost.org/changelog/), and keep your site secure — follow this [guide](/docs/update/) to get started.
