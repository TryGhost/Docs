...
For example, if you imported someone who previously paid &dollar;5 per month with a 20% forever discount, and imported them onto a tier called "Premium" which is normally charged at &dollar;8 per month, their subscription will stay at &dollar;5 with a 20% discount, but on that "Premium" tier.
