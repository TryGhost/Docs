...
New major versions typically involve some backwards incompatible changes. These mostly affect custom themes, and our theme compatibility tool [GScan](/themes/gscan/) will guide you through the updates. If you use custom integrations, the APIs or webhooks you should also expect things to change when switching between [API versions](/faq/api-versioning).
