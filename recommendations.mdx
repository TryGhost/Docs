...
Theme developers can extend the recommendation feature by using the [`recommendations`](/themes/helpers/recommendations/) and [`readable_url`](/themes/helpers/readable_url/) helpers. See the documentation for these features to learn more.