...
<br />
<a href="install/" className='p-2 border rounded-md bg-black text-white'>Get Started →</a>
<br />
<br />
...
<a href="install/ubuntu/" className='p-2 border rounded-md bg-[#e5eaf0] text-[#959698] text-xs'>
Ubuntu
</a>
<a href="install/local/" className='p-2 border rounded-md bg-[#e5eaf0] text-[#959698] text-xs'>
Local
</a>
<a href="install/docker/" className='p-2 border rounded-md bg-[#e5eaf0] text-[#959698] text-xs'>
Docker
</a>
</div>
</div>
