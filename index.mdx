...
<br />
<a href="install/" className='p-2 rounded-md bg-primary text-primary border border-primary dark:border-primary dark:bg-white dark:text-primary'>Get Started →</a>
<br />
<br />
