...
<br />
<a href="install/" className='p-2 rounded-md bg-primary text-primary-light border border-primary dark:border-primary-light dark:bg-primary-light dark:text-primary-dark'>Get Started →</a>
<br />
<br />
