...
The most common gotcha when fetching posts from the Content API is not using the [include](/docs/content-api/parameters#include) parameter to request related data such as tags and authors. By default, the response for a post will not include these:
