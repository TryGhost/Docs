...
<Note>
Check out the official install guides for [development](/docs/install/local/) and [production](/docs/install/ubuntu/).
...
[Mailgun](https://www.mailgun.com/) is a service for sending emails and provides more than adequate resources to send bulk emails at a reasonable price. Find out more about [using Mailgun with Ghost here](/docs/faq/mailgun-newsletters/).
