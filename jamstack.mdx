...
<CardGroup cols={3}>
  <Card
    title="Next.js"
    href="/jamstack/next/"
    icon="/images/9994e9a8-nextjs-logo.svg"
    alt="Next.js logo"
  />
  <Card
    title="Gatsby"
    href="/jamstack/gatsby/"
    icon="/images/cf116fbd-gatsby-logo.svg"
    alt="Gatsby logo"
  />
  <Card
    title="Hexo"
    href="/jamstack/hexo/"
    icon="/images/475cf82c-hexo-logo.svg"
    alt="Hexo logo"
  />
  <Card
    title="Nuxt.js"
  ...
  <Card
    ...
    icon="/images/fff9bebe-gridsome-logo.svg"
    alt="Gridsome logo"
  />
  <Card
    title="Eleventy"
    href="/jamstack/eleventy/"
    icon="/images/0d290655-eleventy-logo.svg"
    alt="Eleventy logo"
  />
  <Card
