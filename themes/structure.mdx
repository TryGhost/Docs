...
An optional theme template for AMP ([Accelerated Mobile Pages](https://www.ampproject.org/get_started/about-amp.html)). If your theme doesn’t provide an `amp.hbs` file, Ghost will use its default.
