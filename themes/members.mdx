...
<Frame>
  <img src="/images/324b141a-portal-links-admin_hu72ea77dfe2902b5b8f1e717e5c1c751c_474136_2376x0_resize_q100_h2_box_3.webp" />
</Frame>
...
Create a dynamic signup form at the theme level by using the [`get` helper](/themes/helpers/get/) to fetch a site’s `newsletters`. Then, loop through the newsletters and add the `name` property to an `input` element. See below for an example implementation:
...
<Frame>
  <img src="/images/2d462c05-content-cta_hu3d640371aa932b7b360881a3df965f9b_54918_1462x0_resize_q100_h2_box_3.webp" />
</Frame>
...
<Frame>
  <img src="/images/4f101771-theme-account-example_hua1cc91f659d30ed537e78ceeee649a6e_60374_800x0_resize_q100_h2_box_3.webp" />
</Frame>
...
The `{{price}}` helper has many options with detailed documentation [here](/themes/helpers/price/).
