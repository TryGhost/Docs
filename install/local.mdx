...
This install is **not** suitable for [production use](/docs/install/ubuntu/) or [contributing](/docs/install/source/) to core.
...
[Ghost-CLI](/docs/ghost-cli/) is a commandline tool to help you get Ghost installed and configured for use, quickly and easily. The npm module can be installed with `npm` or `yarn` on a local machine, depending on your preference.
...
For troubleshooting and errors, try searching this documentation and [FAQ section](/docs/faq/) to find information about common error messages.

***

## Developing Themes

To work on a [Ghost Handlebars Theme](/docs/themes/) locally, your custom theme should always be placed in the top-level `/content/themes/` directory.
...
For more information about theme development read the [Handlebars theme documentation](/docs/themes/) and check out the [tutorials](/tutorials/).