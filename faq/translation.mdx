...
Theme developers can use the `translate` helper to make a theme translatable—see [our docs](/themes/helpers/translate/) for instructions on usage and examples.
