...
| Verb | Path                               | Method                |
| ---- | ---------------------------------- | --------------------- |
| GET  | [/posts/](/docs/content-api/posts)                  | Browse posts          |
| GET  | [/posts/\{id}/](/docs/content-api/posts)            | Read a post by ID     |
| GET  | [/posts/slug/\{slug}/](/docs/content-api/posts)     | Read a post by slug   |
| GET  | [/authors/](/docs/content-api/authors)              | Browse authors        |
| GET  | [/authors/\{id}/](/docs/content-api/authors)        | Read an author by ID  |
| GET  | [/authors/slug/\{slug}/](/docs/content-api/authors) | Read a author by slug |
| GET  | [/tags/](/docs/content-api/tags)                    | Browse tags           |
| GET  | [/tags/\{id}/](/docs/content-api/tags)              | Read a tag by ID      |
| GET  | [/tags/slug/\{slug}/](/docs/content-api/tags)       | Read a tag by slug    |
| GET  | [/pages/](/docs/content-api/pages)                  | Browse pages          |
| GET  | [/pages/\{id}/](/docs/content-api/pages)            | Read a page by ID     |
| GET  | [/pages/slug/\{slug}/](/docs/content-api/pages)     | Read a page by slug   |
| GET  | [/tiers/](/docs/content-api/tiers)                  | Browse tiers          |
| GET  | [/settings/](/docs/content-api/settings)            | Browse settings       |
