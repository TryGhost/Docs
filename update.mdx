...
**[Updates](/update-major-version/) are recommended for sites that are:**

* Running Ghost version `3.0.0` or higher and are using MySQL in production
* Development sites using any database

**[A full reinstall](/reinstall/) of Ghost is recommended for sites that are:**
...
| ------------- | -------- | ------------------------------------- |
| 0.x           | Any      | [Reinstall](/reinstall/)         |
| 1.x           | Any      | [Reinstall](/reinstall/)         |
| 2.x           | Any      | [Reinstall](/reinstall/)         |
| 3.x           | SQLite   | [Reinstall](/reinstall/)         |
| 3.x           | MySQL    | [Update](/update-major-version/) |
| 4.x           | SQLite   | [Reinstall](/reinstall/)         |
| 4.x           | MySQL    | [Update](/update-major-version/) |
