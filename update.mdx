...
<Info>
  The new web analytics feature is not compatible with Ghost-CLI sites. We have a new docker-based hosting method currently in preview, which includes a migration tool for Ghost CLI site: [check it out](https://docs.ghost.org/install/docker).
</Info>
